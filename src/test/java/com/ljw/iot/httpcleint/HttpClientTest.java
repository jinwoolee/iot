...
public class HttpClientTest {
	...
	// read firebase test
	@Test
	public void readFirebaseTest() throws IOException, InterruptedException, ExecutionException {
		...
		//getDate메소드를 호출하면 convertToDateIfNecessary(), areTimestampsInSnapshotsEnabled() 설정에 의해,
		//date로 자동 형변환됨. 
